...
FIGURE_PARAMS = \
    {'al_limit': {'figure.subplots_right': 0.8,
     ...
     'ALPDF': {'subplot.kind': 'violin',
               'palette': [R, LB, B, R, LB, B, R, LB, B, R, G, G],
               'xaxis.tick_labels': (AL.format('125'), MX.format('125'),
                                     RQ.format('125'), AL.format('250'),
                                     MX.format('250'), RQ.format('250'),
                                     AL.format('500'), MX.format('500'),
                                     RQ.format('500'),
                                     'Active learning\nunlimited requests',
                                     'Increase sample\nsize by 10 times',
                                     'Increase sample\nsize by 100 times'),
               ...
               'violin.width': 0.9,
               'violin.scale': 'width'},
     'ALPDP': {'subplot.kind': 'violin',
               'palette': [R, LB, B, R, LB, B, R, LB, B, R, G, G],
               'xaxis.tick_labels': (AO.format('125'), PH.format('125'),
                                     TR.format('125'), AO.format('250'),
                                     PH.format('250'), TR.format('250'),
                                     AO.format('500'), PH.format('500'),
                                     TR.format('500'),
               ...
               'legend.key': {'Active learning (orientation)': '#c44e52',
                              'Predefined prohibited arcs': '#64b5cd',
...
SERIES_GROUPS = {'HC_BNBENCH': ['HC/OPT', 'HC/BAD', 'HC/STD'],
                 ...
                 'SCORE': ['BNLEARN/HC_STD', 'BNLEARN/HC_BDE',
                           'BNLEARN/HC_BDS'],
                 ...
                 'ALPDF': ['TABU/BASE',  # Active Learning/predefined comp
                           'TABU/EQV/L012', 'TABU/MIX9/L012', 'TABU/REQD/L012',
                           'TABU/EQV/L025', 'TABU/MIX9/L025', 'TABU/REQD/L025',
                           'TABU/EQV/L050', 'TABU/MIX9/L050', 'TABU/REQD/L050',
                           'TABU/EQV/E100'],

                 'ALPDP': ['TABU/BASE',  # Active Learning/predefined comp
                           'TABU/EQVP/L012', 'TABU/STOP/L012',
                           'TABU/TIERS/L012',
                           'TABU/EQVP/L025', 'TABU/STOP/L025',
                           'TABU/TIERS/L025',
                           'TABU/EQVP/L050', 'TABU/STOP/L050',
                           'TABU/TIERS/L050',
                           'TABU/EQVP/E100'],
...
SERIES = {
    ...
    'TABU/BDEU_BASE2': {'package': Package.BNBENCH,
                        ...
                        'randomise': ([Randomise.ORDER, Randomise.NAMES], 25)},
    'TABU/BDEU_BASE3': {'package': Package.BNBENCH,
                        'params': {'tabu': 10, 'score': 'bde', 'iss': 1},
                        'randomise': ([Randomise.ORDER, Randomise.NAMES,
                                       Randomise.ROWS], 25)},
    'TABU/STABLE': {'package': Package.BNBENCH,
                    ...
                    'randomise': ([Randomise.ORDER, Randomise.NAMES], 3)},
    'TABU/T4_0_M1': {'package': Package.BNBENCH,
                     'params': {'tabu': 10, 'bnlearn': False, 'stable': True,
                                'tree': (4, 0, -1)},
                     'randomise': ([Randomise.ORDER, Randomise.NAMES], 3)},
    'TABU/T7_0_M1': {'package': Package.BNBENCH,
                     'params': {'tabu': 10, 'bnlearn': False, 'stable': True,
                                'tree': (7, 0, -1)},
                     'randomise': ([Randomise.ORDER, Randomise.NAMES], 3)},
    'TABU/T8_0_M1': {'package': Package.BNBENCH,
                     'params': {'tabu': 10, 'bnlearn': False, 'stable': True,
                                'tree': (8, 0, -1)},
                     'randomise': ([Randomise.ORDER, Randomise.NAMES], 3)},
    'TABU/T1_1_0': {'package': Package.BNBENCH,
                    'params': {'tabu': 10, 'bnlearn': False, 'stable': True,
                               'tree': (1, 1, 0)},
                    'randomise': ([Randomise.ORDER, Randomise.NAMES], 3)},
    'TABU/T1_1_100': {'package': Package.BNBENCH,
                      'params': {'tabu': 10, 'bnlearn': False, 'stable': True,
                                 'tree': (1, 1, 100)},
                      'randomise': ([Randomise.ORDER, Randomise.NAMES], 3)},
    'TABU/GREEDY': {'package': Package.BNBENCH,
                    'params': {'tabu': 10, 'stable': 'dec_score',
                               'tree': (1, 1, 100)},
                    'randomise': ([Randomise.ORDER, Randomise.NAMES], 3)},
    'TABU/GREEDY_SP': {'package': Package.BNBENCH,
    ...
    'TABU/STABLE/SCORE_PLUS': {'package': Package.BNBENCH,
                               ...
                               'randomise': ([Randomise.ORDER,
                                              Randomise.NAMES], 25)},
    'TABU/STABLE/BDEU_PLUS': {'package': Package.BNBENCH,
                              'params': {'tabu': 10, 'stable': 'score+',
                                         'score': 'bde', 'iss': 1},
                              'randomise': ([Randomise.ORDER,
                                             Randomise.NAMES], 25)},
    ...
    'HC/ORDER/KLI16': {'package': Package.BNBENCH,
                       ...
                       'kparams': {'limit': 16, 'ignore': 16,
                                   'expertise': 1.0},
                       'randomise': ([Randomise.ORDER], 10)},
    'HC/SCORE/BIC': {'package': Package.BNBENCH,
                     'params': {'base': 'e', 'score': 'bic', 'k': 1,
                                'maxiter': 1}},  # just use to get ref score
    ...
    'TETRAD/FGES_BASE3': {'package': Package.TETRAD,
                          ...
                          'randomise': ([Randomise.NAMES, Randomise.ORDER,
                                         Randomise.ROWS], 25),
                          'params': {'score': 'bic', 'k': 1}},
    'TETRAD/FGES_BDEU2': {'package': Package.TETRAD,
                          'algorithm': Algorithm.FGES,
                          'randomise': ([Randomise.NAMES, Randomise.ORDER],
                                        25),
